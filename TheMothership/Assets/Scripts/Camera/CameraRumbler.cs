...
public class CameraRumbler : MonoBehaviour {
          ...
          /// <summary>
           ...
           /// </summary>
           public static CameraRumbler Instance;
           static Dictionary<string, CameraRumbler> instanceList = new Dictionary<string, CameraRumbler>();
           ...
           /// <returns></returns>
           public static CameraRumbler GetInstance(string name)
           {
        CameraRumbler c;
