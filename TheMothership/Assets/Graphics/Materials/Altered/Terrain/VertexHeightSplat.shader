...
Shader "MixTerrain/VertexHeightSplat" {
	...
	SubShader {
		...
		void surf (Input IN, inout SurfaceOutputStandard o) {
			...
			//===================== 2
				half parallaxX1 = tex2D (_ParallaxMap1, xUV1).r;
				half parallaxY1 = tex2D (_ParallaxMap1, yUV1).g;
				half parallaxZ1 = tex2D (_ParallaxMap1, zUV1).b;
			...
			//===================== 2
			fixed4 texX1 = tex2D(_MainTex1, xUV1);
			fixed4 texY1 = tex2D(_MainTex1, yUV1);
			fixed4 texZ1 = tex2D(_MainTex1, zUV1);			
			...
			*/
			...
			//===================== 2
			fixed3 bumpX1 = UnpackScaleNormal(tex2D(_BumpMap1, xUV1), _BumpScale);
			fixed3 bumpY1 = UnpackScaleNormal(tex2D(_BumpMap1, yUV1), _BumpScale);
			fixed3 bumpZ1 = UnpackScaleNormal(tex2D(_BumpMap1, zUV1), _BumpScale);
